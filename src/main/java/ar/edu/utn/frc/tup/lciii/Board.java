...
public class Board {
    ...
    /**
     * Letter to represent the sunked ship object in the board
     */
    private static final String SUNKED_SHIP = "\u001B[31mX";
    ...
    public void setShipPositions(List<Ship> ShipList) {
        ...
        for (Ship ship : ShipList) {
            setShipOnBoard(ship.getPosition());
        }
    }
    ...
    /**
     * Este metodo pone "X" (sunked shgip/barco) en la posicion del tablero pasada por parametro
     *
     * @param position Posicion donde poner un barco hundido
     *
     * @see #SHIP
     */
    public void setSunkedShipOnBoard(Position position) {
        // TODO: Setear en el board el valor de SHIP en la posicion indicada por parametro
        this.board[position.getRow()][position.getColumn()] = SUNKED_SHIP;
    }
